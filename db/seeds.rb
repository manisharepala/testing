...
mmcq_data = {question_language_specific_datas_attributes: [{question_text: 'Mmcq Question in English',general_feedback:'Solution in english', hint:'hint in english',actual_answer:'Answer in english', language: 'english'}, {question_text: 'Mmcq Question in Hindi',general_feedback:'Solution in hindi', hint:'hint in hindi',actual_answer:'Answer in hindi', language: 'hindi'}],default_mark:1,penalty:0, 'qtype'=> 'MmcqQuestion', created_by: 23, publisher_question_bank_ids: qb_ids, tag_ids: tag_ids, question_answers_attributes: [{answer_english: 'Option 1 English',answer_hindi: 'Option 1 Hindi', fraction: true}, {answer_english: 'Option 2 English',answer_hindi: 'Option 2 Hindi', fraction: true}, {answer_english: 'Option 3 English',answer_hindi: 'Option 3 Hindi', fraction: false}, {answer_english: 'Option 4 English',answer_hindi: 'Option 4 Hindi', fraction: false}]}
...
assertion_reason_data = {question_language_specific_datas_attributes: [{question_text: 'AssertionReasonQuestion in English',general_feedback:'Solution in english', hint:'hint in english',actual_answer:'Answer in english', language: 'english'}, {question_text: 'AssertionReasonQuestion in Hindi',general_feedback:'Solution in hindi', hint:'hint in hindi',actual_answer:'Answer in hindi', language: 'hindi'}],default_mark:1,penalty:0, 'qtype'=> 'AssertionReasonQuestion', created_by: 23, publisher_question_bank_ids: qb_ids, tag_ids: tag_ids, question_answers_attributes: [{answer_english: 'English: Statement-1 is True, Statement-2 is True; Statement-2 is the correct explanation of Statement-1.',answer_hindi: 'Hindi: Statement-1 is True, Statement-2 is True; Statement-2 is the correct explanation of
...
true_false_data = {question_language_specific_datas_attributes: [{question_text: 'ToF Question in English',general_feedback:'Solution in english', hint:'hint in english',actual_answer:'Answer in english', language: 'english'}, {question_text: 'ToF Question in Hindi',general_feedback:'Solution in hindi', hint:'hint in hindi',actual_answer:'Answer in hindi', language: 'hindi'}],default_mark:1,penalty:0, 'qtype'=> 'TrueFalseQuestion', created_by: 23, publisher_question_bank_ids: qb_ids, tag_ids: tag_ids, question_answers_attributes: [{answer_english: 'True',answer_hindi: 'True in Hindi', fraction: true}, {answer_english: 'False',answer_hindi: 'False in Hindi', fraction: false}]}
