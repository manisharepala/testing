class TagsServer
  ...
  def self.get_tag_guid(name,value,tags_db_id=TAGS_DB_ID)
  ...
  def self.get_tag_guid_by_key(key,tags_db_id=TAGS_DB_ID)
  ...
  def self.get_tags_by_name(name,tags_db_id=TAGS_DB_ID)
  ...
  def self.get_uniq_tag_values_with_guids(tags_db_id=TAGS_DB_ID)
